...
A robust, complete and easy to use appointments scheduling system designed for highly demanding small business.


== Description ==

**Salon Booking System** is a complete and easy to use
...
It’s on the market since 2015, with more than 10.000 websites worldwide using our plugin to handle their appointments.
...
* Official add-ons for "Mollie", "Square", "Worldpay", "Paystack", "RedSys" and "Paytrail"
...
* Easy import of Users, Services and Assistants from a CSV file
...
Salon Booking System can be integrated with third part platforms trough **Zapier.com** integration.
...
* Display time-slots using customer’s time-zone
* Specific available dates for Assistants
* Free access to 30+ add-ons
* Email priority support
* Quick booking overview and shortcuts

[Read more..](https://www.salonbookingsystem.com/homepage/plugin-pricing/).
...
* Web App - Fixed issue with "Add to home screen" link
* Web App - Improved UI of the "services selection menu"
* Improved UI of the "Save this customer" checkbox
...
* Fixed issue related to "daylight saving time"
* Fixed issue with "past hours displayed as available on front-end booking form"
* Fixed issue with "booking rules" hierarchy 
* Fixed issue with the Web App "services selection list"
* Fixed issue with the Web App "new booking for brand new users"
* Fixed issue with PayPal when "create booking after payment only" option is enabled


31.10.2022

* Minor fixes
* Implemented Web App for PRO edition
* Languages translations updated
...
* Fixed issue with auto-refresh of the back-end calendar
...
* Fixed issue with "Adding service to a reservation from back-end, availability control."
* Added Tax calculation feature - PRO edition
* Implemented back-end calendar automatic data update
* Fixed issue with the back-end calendar "status bar"
...
* Fixed compatibility issue with YOAST plugin

02.09.2022

* Various issues fixed and improvements
...
* Added "Default status" option ( PRO )
* Added "Quick booking approval" buttons (PRO)
...
* Fixed zapier.com integration issue


17.06.2022

* Fixed issue with mobile app calendar screen
...
* Fixed issue on back-end calendar monthly view due to user time-zone
...
* Fixed issues with multiple reminiders
...
* Fixed issue with missing "Assistant"
...
* New Zapier.com integration support
